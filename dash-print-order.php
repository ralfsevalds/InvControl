...
<script>
  ...
  function displayOrderDetails(orderDetails) {
    ...
    for (var i = 0; i < orderDetails.length; i++) {
      ...
      row.insertCell().textContent = "$" + orderDetails[i].sale_price;
      row.insertCell().textContent = "$" + (orderDetails[i].quantity * orderDetails[i].sale_price).toFixed(2);
    }
  }
