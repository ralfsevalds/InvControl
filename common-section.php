...
echo '<div class="sidebar">
        <div class="logo">
            <h2><a href="dashboard.php"><img src="invcontrol-logo.png" alt="InvControl Logo" style="height: 50px; vertical-align: middle; border-radius: 10px;"> InvControl</a></h2>
        </div>
        <ul>
    ...
    <div class="main-content">
        <div class="header">
            <div class="user">
                <a href="profail.php"><img src="'. $profilePicture .'" alt="User Image" style="border-radius: 50%;"></a>
