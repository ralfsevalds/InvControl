...
<div class="modal" id="product-modal">
  ...
  <span class="close">&times;</span>
    ...
    <table class="product-table" id="productTable">
      <thead>
        <tr>
     <!-- `id`, `name`, `category`, `quantity`, `sale_price`, `description`, `picture` -->
          <th>ID</th>
          <th>Picture</th>
          <th>Name</th>
          <th>Category</th>
...
productTable.addEventListener('click', function(event) {
  ...
  if (event.target.tagName === 'TD') {
    ...
    var quantity = 1;
    var salePrice = selectedRow.cells[5].textContent;
    // Parse the sale price as a number (assuming it's a valid numeric value)
    var numericSalePrice = parseFloat(salePrice);
    // Calculate the total amount
    var totalAmount = quantity * numericSalePrice;
    ...
    var salePriceCell = newRow.insertCell();
    ...
    `;
    salePriceCell.innerHTML = '<input type="number" name="sale_price[]" value="'+numericSalePrice+'" step="0.01" readonly>';
    ...
    function updateQuantity() {
      ...
      // Calculate the total amount
      totalAmount = quantity * numericSalePrice;
