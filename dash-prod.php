...
foreach($results as $row)
{
    ...
    echo "<td>".$row['price_of_purchase']."</td>";
...
<div class="modal" id="add-product-modal">
    <div class="modal-content">
      ...
      <form action="product.php" method="post" enctype="multipart/form-data">
        ...
        <input type="text" id="product-price-of-purchase" name="product-price-of-purchase" placeholder="Price of Purchase" required>
        <input type="text" id="product-sale-price" name="product-sale-price" placeholder="Sale Price" required>
        <input type="text" id="product-brands" name="product-brands" placeholder="Brands" required>
...
addButton.onclick = function() {
  modal.style.display = "block";
    ...
    document.getElementById("product-price-of-purchase").value = "";
    document.getElementById("product-sale-price").value = "";
    document.getElementById("product-brands").value = "";
...
editButtons.forEach((button)=>{
   ...
   button.addEventListener('click', (event)=>{
       ...
       const price_of_purchase = tableRow.cells[6].textContent;
       const sale_price = tableRow.cells[7].textContent;
       const brands = tableRow.cells[8].textContent;
       ...
       document.getElementById("product-price-of-purchase").value = price_of_purchase;
       document.getElementById("product-sale-price").value = sale_price;
       document.getElementById("product-brands").value = brands;
